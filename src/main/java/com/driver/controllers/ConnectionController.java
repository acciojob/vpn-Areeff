...
public class ConnectionController {
    ...
    public ResponseEntity<Void> communicate(@RequestParam int senderId, @RequestParam int receiverId) throws Exception{
        ...
        // receiver's current country, we need to connect the sender to a suitable vpn. If there are
        // multiple options, connect using the service provider having smallest id
        ...
        //If communication can not be established due to any reason, throw "Cannot establish communication"
        // exception
